  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#2F93C8" />
          <stop offset="1" stopColor="#03B9B9" />
        </linearGradient>
      </defs>
    </svg>
  );
...
export function RepeatIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function SlidersIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ImagePlusIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
